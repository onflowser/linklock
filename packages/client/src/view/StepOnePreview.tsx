...
export function StepOnePreview({
    ...
    const isMembershipActive = (membership: MembershipNFT | undefined): boolean => {
    ...
    return (
        <div className="step-container">
            ...
            <div className={"button-wrapper"}>
                <Button onClick={onCompleteStep} disabled={isMembershipActive(ownedTargetMembership)}>REDEEM</Button>
            </div>
        </div>
    );
}
